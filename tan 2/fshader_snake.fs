...
//    }
    switch (Mdiffuse) {
        case 0: color1=ourColor; break;
        case 1: color1=vec3(0.21,0.27,0.7); break;
        case 2: color1=vec3(0.1,0.27,0.21); break;
        case 3: color1=vec3(0,1,0); break;
        case 4: color1=vec3(0.1,0.27,0.21); break;
        case 5: color1=vec3(0.80,0,0); break;
        case 6: color1=vec3(0.1,0.27,0.21); break;
        case -1: color1=vec3(0.52,0.22,0.40); break;
        case -2: color1=vec3(0.51,0.22,0.46); break;
        case -3: color1=vec3(0.46,0.51,0.21); break;
        case -4: color1=vec3(0.22,0.47,0.51); break;
        case -5: color1=vec3(0.22,0.51,0.49); break;
