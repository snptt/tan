...
void main()
{
    ...
    vec3 sh = vec3(1.0,1.0,1.0)-mix(vec3(texture(material.specular, texForS).xyz),vec3(texture(material.specular, texForS2).xyz),abs(offset2-0.5)/2+0.5)*flit*(-sin(acos(mod(offset2,0.2)*10-1)*2+radians(90.0))+1)/2;
